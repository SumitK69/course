...
summary(log_mod1)$null.deviance
summary(log_mod1)$deviance
...
summary(log_mod2)$null.deviance
summary(log_mod2)$deviance
...
summary(log_mod3)$null.deviance
summary(log_mod3)$deviance