...
randomForest(Region~Country,data=train,ntree=35) ->mod_forest1
...
randomForest(gender~TotalCharges,data=train,ntree=35) ->mod_forest2
...
randomForest(DrugID~LocationID,data=train,ntree=35) ->mod_forest3
